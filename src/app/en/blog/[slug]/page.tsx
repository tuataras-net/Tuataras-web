  ...
  return (
    <PageShell lang="en" title="" hideTitle>
      <article className="mx-auto max-w-3xl">
        {/* Back */}
        <a href="/en/blog" className="inline-flex items-center gap-1 text-sm text-muted hover:text-corp transition-colors mb-8">
          ← Back to Blog
        </a>
        ...
        <div className="mt-16 rounded-3xl border border-corp bg-corp-soft p-8 text-center">
          <h2 className="text-xl font-semibold text-corp">Found this article useful?</h2>
          <p className="mt-2 text-sm text-muted">Let's talk about how to apply these ideas in your project.</p>
          <a href="/en/contact" className="btn-primary mt-5 inline-block rounded-full px-7 py-3 text-sm font-semibold">
            Contact us
          </a>
        </div>
      </article>
