...
export default function Page() {
  return (
    <PageShell lang="es" title="Tuataras">
      ...
      <section className="mt-16">
        ...
        <div className="mt-4 grid grid-cols-2 gap-6 text-sm text-muted sm:grid-cols-4">
          <div className="rounded-xl border border-corp px-4 py-6 text-center">Cliente A</div>
          <div className="rounded-xl border border-corp px-4 py-6 text-center">Cliente B</div>
          <div className="rounded-xl border border-corp px-4 py-6 text-center">Cliente C</div>
          <div className="rounded-xl border border-corp px-4 py-6 text-center">Cliente D</div>
        </div>
      </section>
